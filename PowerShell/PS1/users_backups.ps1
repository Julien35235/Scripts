...
Robocopy $compte $destination /MIR /XD "$compte\OneDrive" /XA:SH /XJD /W:5 /R:3 /MT:32 /V /NP LOG:C:\LOGS\BackupLogs\log.txt /TEE
Write-Host "La sauvegarde du profil est terminer. Les log sont disponible ici : C:\LOGS\BackupLogs\log.txt" -ForegroundColor Green
# Créer le dossier de logs s'il n'existe pas
#$logDir = "C:\Logs1\$profilname"
